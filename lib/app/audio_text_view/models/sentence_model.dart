...
class SentenceData {
  ...
  SentenceData({required this.id, required this.start, required this.end, required this.words});
  ...
  factory SentenceData.fromJson(Map<String, dynamic> json) {
    try {
      ...
      return SentenceData(id: json['id'] as String, start: json['start'] as int, end: json['end'] as int, words: wordsList);
    } catch (e) {
